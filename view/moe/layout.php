...
*/
	...
	<style>
		body {
			background-image: url(http://ww1.sinaimg.cn/large/71c534f0ly1fw9tw14zb3j21hc0u01e4.jpg) !important;  /*背景图*/ 
		...
		<div class="inner">
			<nav class="site-nav">
				<div class="site-nav-left">
					<a class="site-nav-logo" href="http://pan.jlju.me/"><img src='https://oneindex-icemkzspae.now.sh/?/%E4%B8%AA%E4%BA%BA/600x429.png' /></a>
					<ul class="nav" role="menu">
						<li class="nav-blog" role="menuitem"><a href="https://www.hilence.me" style="font-size:12px; text-decoration: none;">Blog</a></li>
						<!--不需要已注释
						<li class="nav-" role="menuitem"><a href="http://flinty.top/friends/" style="font-size:12px; text-decoration: none;">友情链接</a></li>
						-->
						<li class="nav-img" role="menuitem"><a href="http://img.hilence.me" style="font-size:12px; text-decoration: none;">图床</a></li>
						<!--不需要已注释
						<li class="nav-" role="menuitem"><a href="http://flinty.top/ghost" style="font-size:12px; text-decoration: none;">博客后台</a></li>
						-->
						<li class="nav-" role="menuitem"><a href="http://pan.jlju.me/?/admin" style="font-size:12px; text-decoration: none;">网盘后台</a></li>
					</ul>

                <!-- 右上角包括Facebook、Twitter等部分不需要
				</div>
